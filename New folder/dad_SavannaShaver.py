...
def setup():
    global player1_pos,player1_vel, size, stage,time_remaining,ticks,coins,sad,fun,unicorn,jelly,click,score1,win,hit_list
        ...
        if win:
            ...
            if  5 < sec <= 7:
                 ...
                 if sec >= 7:
                    ...
                    #text5 = MY_FONT.render((name)+ ":" + str(time_remaining), True, WHITE)
                      
                    screen.blit(text2, [125, 200])
                    screen.blit(text4, [125, 300])
                    #screen.blit(text5, [125, 500])
                    screen.blit(text6, [125, 400])
